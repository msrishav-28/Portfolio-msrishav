...
export const TimelineSection = () => {
	...
	return (
		<section id="timeline" className="py-20">
			<h2 className="text-4xl font-mono font-bold mb-12">Education & Experience</h2>

			<div ref={ref} className="relative max-w-4xl mx-auto">
				{/* Timeline line */}
				<div className="absolute left-4 md:left-1/2 transform md:-translate-x-1/2 h-full w-0.5 bg-gray-700" />
				...
				{timelineItems.map((item, index) => (
					...
					>
						{/* Timeline dot */}
						<div className="absolute left-4 md:left-1/2 transform -translate-x-1/2 w-8 h-8 rounded-full bg-light-blue flex items-center justify-center">
							{item.type === 'education' ? (
						...
						>
							<div className="bg-[#1a1b2e] p-6 rounded-lg">
								<span className="text-light-blue font-mono">{item.year}</span>
